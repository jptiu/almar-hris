        ...
        <div class="space-y-8">
                    ...
                    @can('hr_access')
                        ...
                        <li class="px-3 py-3 rounded-sm mb-0.5 last:mb-0 @if (in_array(Request::segment(1), ['customer'])) {{ 'bg-slate-900' }} @endif"
                            ...
                            <a href="{{ route('customer.index') }}"
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div
                                        ...
                                        <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-slate-400 @if (in_array(Request::segment(1), ['customer'])) {{ 'rotate-180' }} @endif"
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1 @if (in_array(Request::segment(1), ['customer'])) {{ 'bg-slate-900' }} @endif"
                                    x-data="{ open: {{ in_array(Request::segment(1), ['loan']) ? 1 : 0 }} }">
                                    <li class="mb-1 last:mb-0">
                                        <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if (Route::is('customer-add')) {{ '!text-indigo-500' }} @endif"
            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <!-- Settings -->
                    <li class="px-3 py-3 rounded-sm mb-0.5 last:mb-0 @if (in_array(Request::segment(1), ['settings'])) {{ 'bg-slate-900' }} @endif"
