<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        @endif
        <div class="relative">
            <h1 class="text-2xl md:text-2xl text-slate-800 dark:text-slate-100 font-bold mb-12">Customer Lists
            </h1>
        </div>
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-4">
            <div>
                <form method="GET" action="{{route('customers.index')}}" class="flex items-center max-w-sm mx-auto">
