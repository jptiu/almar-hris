<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="relative">
            <h1 class="text-2xl md:text-2xl text-slate-800 dark:text-slate-100 font-bold mb-12">Daily Work Order Request Form</h1>
        </div>

        <div class="bg-slate-200 p-3 rounded-t-lg">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                <div>
                    <h1 class="text-xl md:text-xl text-slate-600 dark:text-slate-100 font-bold ml-2">Create Work Order</h1>
                </div>
                    ...
                    <form>
                        ...
                        <div class="md:col-span-1"></div>
                            <div class="md:col-span-2">
                                <label for="customer" class="text-black font-medium">Select Assignee</label>
                                <div class="relative">
                            ...
                            <div class="md:col-span-1"></div>
                            <div class="md:col-span-2">
                                <label for="startDate" class="block text-sm font-medium text-gray-700">Due Date</label>
                            ...
                            <div class="md:col-span-2">
                                <label for="amount_due" class="block text-sm font-medium text-gray-700">Task Name</label>
