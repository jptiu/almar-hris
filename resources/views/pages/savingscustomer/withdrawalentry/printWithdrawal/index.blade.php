...
<div class="print-container">
    <div>
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center">
                <div class="text-gray-600">
                    <div class="text-md font-bold">Ref. No: {{$withdraw->id}}</div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-4">
            <div><strong>Account Holder Name:</strong> {{$withdraw->customer->first_name}} {{$withdraw->customer->last_name}}</div>
        </div>
        <table>
            <thead>
            <tr>
    ...
    <div class="flex justify-between items-center">
            <div class="items-center">
                ...
                <div class="text-center mt-2">Account Holders's Signature</div>
            </div>
            <div class="items-center">
                <hr class="w-full mt-2" />
                <div class="text-center mt-2">Withdrawal Processed By:</div>
            </div>
        </div>
</div>
