                                        ...
                                        <div class="lg:col-span-2">
                                            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-1">
                                                <div class="md:col-span-1">
                                                    ...
                                                    <input type="text" name="payment_method" id="payment_method" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{$employee->f_name.' '.$employee->l_name}}" placeholder="" />
                                                </div>
                                            </div>  
                                        </div>
                                    </div>
                                        ...
                                        <div class="lg:col-span-2">
                                            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-1">
                                                <div class="md:col-span-1">
                                                    ...
                                                    <input type="text" name="payment_method" id="payment_method" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{$employee->date_hired}}" placeholder="" />
                                                </div>
                                            </div>  
                                        </div>
                                    </div>
                                ...
                                <div class="mb-8">
                                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-1">
                                        <div class="lg:col-span-2">
                                            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-1">
                                                <div class="md:col-span-1">
                                                    <label for="room_floor">Probation Status</label>
                                                    <select name="room_floor" id="room_floor" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" />
                                                        <option value="1st">Probation</option>
                                                        <option value="1st">Regular</option>
                                                    </select>
                                                </div>
                                            </div>  
                                        </div>
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-1">                    
                                    <div class="md:col-span-1">
                                        <div class="inline-flex items-start" style="float: right;">
                                            <button type="submit" class="bg-blue-400 hover:bg-primary-500 text-white font-bold py-2 px-4 rounded">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
