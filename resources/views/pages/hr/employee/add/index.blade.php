<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="relative">
            <h1 class="text-2xl md:text-2xl text-slate-800 dark:text-slate-100 font-bold mb-12">Employment Information
                Sheet</h1>
        </div>
        ...
        <form action="{{ route('employee.store') }}" method="POST">
            ...
            <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                <div id="loading"
                    ...
                    <div class="loader ease-linear rounded-full border-8 border-t-8 border-gray-200 h-32 w-32 mb-4">
                    </div>
                </div>
                ...
                <div id="step1" class="">
                    ...
                    <div>
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 mb-6">
                            <div>
                                <h1 class="text-xl md:text-xl text-slate-600 dark:text-slate-100 font-bold mb-1">
                                    Personal Detail</h1>
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2">
                                    <div class="md:col-span-1">
                                        <select name="position_desired" id="position_desired"
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2">
                                    ...
                                    <div class="md:col-span-1">
                                        ...
                                        <div>
                                            <input name="tel_number" id="tel_number"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6 mb-4">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="f_spouse" id="f_spouse"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="l_spouse" id="l_spouse"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="m_spouse" id="m_spouse"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                ...
                                <div class="lg:col-span-2 mb-4">
                                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4">
                                        ...
                                        <div class="md:col-span-1">
                                            ...
                                            <input type="text" name="child_1_age" id="child_1_age"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" placeholder="" />
                                        </div>
                                        ...
                                        <div class="md:col-span-1 flex items-start justify-start mt-8">
                                            <button type="button" id="add-child"
                                                class="text-slate-600 px-2 py-1 rounded hover:text-orange-500 italic text-sm">Click
                                                here to add Children Info</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="lg:col-span-2 mb-4 hidden" id="child2">
                                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4">
                                        <div class="md:col-span-2">
                                            ...
                                            <input type="text" name="child_2_name" id="child_2_name"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" placeholder="" />
                                        </div>
                                        ...
                                        <div class="md:col-span-1">
                                            ...
                                            <input type="text" name="child_2_age" id="child_2_age"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" placeholder="" />
                                        </div>
                                        ...
                                        <div class="md:col-span-1 flex items-start justify-start mt-8">
                                            <button type="button"
                                                class="text-red-400 text-sm px-2 py-1 rounded remove-child italic">Remove</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="lg:col-span-2 mb-4 hidden" id="child3">
                                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4">
                                        <div class="md:col-span-2">
                                            ...
                                            <input type="text" name="child_3_name" id="child_3_name"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" placeholder="" />
                                        </div>
                                        ...
                                        <div class="md:col-span-1">
                                            ...
                                            <input type="text" name="child_3_age" id="child_3_age"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" placeholder="" />
                                        </div>
                                ...
                                <div class="lg:col-span-2 mb-8">
                                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6 mb-4">
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <div>
                                                <input name="m_maiden_f_name" id="m_maiden_f_name"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                    value="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <div>
                                                <input name="m_maiden_l_name" id="m_maiden_l_name"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                    value="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <div>
                                                <input name="m_maiden_m_name" id="m_maiden_m_name"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                    value="" />
                                            </div>
                                        </div>
                                ...
                                <div class="lg:col-span-2 mb-4">
                                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6 mb-2">
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <div>
                                                <input name="father_f_name" id="father_f_name"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                    value="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <div>
                                                <input name="father_l_name" id="father_l_name"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                    value="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <div>
                                                <input name="father_m_name" id="father_m_name"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                    value="" />
                                            </div>
                                        </div>
                    ...
                    <div>
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 mb-4">
                            <div>
                                <h1 class="text-xl md:text-xl text-slate-600 dark:text-slate-100 font-bold mb-1">In
                                    case of Emergency</h1>
                                ...
                                <div class="lg:col-span-2 mb-8">
                                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-1 mb-4">
                                        ...
                                        <div class="md:col-span-1">
                                            ...
                                            <div>
                                                <input name="person_emergency" id="person_emergency"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                    value="" />
                                            </div>
                                        </div>
                ...
                <div id="step2" class="hidden">
                    <div class="flex place-content-center justify-center items-center mb-16 mt-2">
                        <ol class="space-y-4 sm:flex sm:space-x-6 sm:space-y-0 rtl:space-x-reverse">
                            <li
                                class="flex items-center text-gray-500 dark:text-blue-500 space-x-2.5 rtl:space-x-reverse">
                                <span
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="elementary" id="elementary"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="elem_address" id="elem_address"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="elem_year" id="elem_year"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="sec_address" id="sec_address"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="sec_year" id="sec_year"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="college_year" id="college_year"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="course_address" id="course_address"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="course_year" id="course_year"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="vocational" id="vocational"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="voc_address" id="voc_address"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="voc_year" id="voc_year"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                ...
                <div id="step3" class="hidden">
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6 mb-4">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="n_company_1" id="n_company_1"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="a_company_add_1" id="a_company_add_1"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="p_company_1" id="p_company_1"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input type="date" name="f_company_1" id="f_company_1"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input type="date" name="t_company_1" id="t_company_1"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2 flex items-start justify-start mt-8">
                                        <button type="button" id="add-employment"
                                            class="text-slate-600 px-2 py-1 rounded hover:text-orange-500 italic text-sm">Add
                                            Employment</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="lg:col-span-2 mb-4 hidden" id="employment2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="n_company_2" id="n_company_2"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        <label for="a_company_1">Address</label>
                                        <div>
                                            <input name="a_company_1" id="a_company_1"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="p_company_2" id="p_company_2"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6 mt-4">
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input type="date" name="f_company_2" id="f_company_2"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input type="date" name="t_company_2" id="t_company_2"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2 flex items-start justify-start mt-8">
                                        <button type="button"
                                            class="text-red-400 text-sm px-2 py-1 rounded remove-employment italic">Remove</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="lg:col-span-2 mb-4 hidden" id="employment3">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="n_company_3" id="n_company_3"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="a_company_add_3" id="a_company_add_3"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="p_company_3" id="p_company_3"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6 mt-4">
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input type="date" name="f_company_3" id="f_company_3"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input type="date" name="t_company_3" id="t_company_3"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4 mb-4">
                                    ...
                                    <div class="md:col-span-1">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" id="sss-benefit"
                                                class="form-checkbox h-5 w-5 text-blue-600"
                                                onchange="toggleInput('sss-input-container', 'sss-dropdown')" />
                                    ...
                                    <div class="md:col-span-1">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" id="pagibig-benefit"
                                                class="form-checkbox h-5 w-5 text-blue-600"
                                                onchange="toggleInput('pagibig-input-container', 'pagibig-dropdown')" />
                                    ...
                                    <div class="md:col-span-1">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" id="philhealth-benefit"
                                                class="form-checkbox h-5 w-5 text-blue-600"
                                                onchange="toggleInput('philhealth-input-container', 'philhealth-dropdown')" />
                                    ...
                                    <div class="md:col-span-1">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" id="tin-benefit"
                                                class="form-checkbox h-5 w-5 text-blue-600"
                                                onchange="toggleInput('tin-input-container', 'tin-dropdown')" />
                    ...
                    <div>
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 mb-6">
                            <div class="text-gray-600">
                                <p class="font-medium text-lg">Character Reference <span class="text-slate-400">(not
                                        related to you)</span></p>
                            </div>
                            ...
                            <div class="lg:col-span-2 mb-4">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-10">
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="cf_name_1" id="cf_name_1"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="cf_occ_1" id="cf_occ_1"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="cf_add_1" id="cf_add_1"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="cf_phone_1" id="cf_phone_1"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        <div class="md:col-span-2 flex items-start justify-start mt-8">
                                            <button type="button" id="add-character-reference"
                                                class="text-slate-600 px-2 py-1 rounded hover:text-orange-500 italic text-sm">Add
                                                Reference</button>
                                        </div>
                                    </div>
                            ...
                            <div class="lg:col-span-2 mb-4 hidden" id="character-reference2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-10">
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="cf_name_2" id="cf_name_2"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="cf_occ_2" id="cf_occ_2"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="cf_add_2" id="cf_add_2"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="cf_phone_2" id="cf_phone_2"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        <div class="md:col-span-2 flex items-start justify-start mt-8">
                                            <button type="button"
                                                class="text-red-400 text-sm px-2 py-1 rounded remove-character-reference italic">Remove</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="lg:col-span-2 mb-4 hidden" id="character-reference3">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-10">
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="cf_name_3" id="cf_name_3"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="cf_occ_3" id="cf_occ_3"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="cf_add_3" id="cf_add_3"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div>
                                            <input name="cf_phone_3" id="cf_phone_3"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5"
                                                value="" />
                                        </div>
                                    </div>
                ...
                <div id="step4" class="hidden">
                    ...
                    <div>
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 mb-6">
                            <div>
                                <h1 class="text-xl md:text-xl text-slate-600 dark:text-slate-100 font-bold mb-1">Upload
                                    File</h1>
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2 mb-6">
                                    ...
                                    <div id="pagibig-dropdown-container" class="md:col-span-1">
                                        ...
                                        <select name="pagibig" id="pagibig"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5" />
                                        <option value="To Be Submitted">To Be Submitted</option>
                                        <option value="Pending">Pending</option>
                                        </select>
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2 mb-6">
                                    <div id="philhealth-dropdown-container" class="md:col-span-1">
                                        ...
                                        <select name="philhealth" id="philhealth"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-2 p-2.5" />
                                        <option value="To Be Submitted">To Be Submitted</option>
                                        <option value="Pending">Pending</option>
                                        </select>
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2 mb-6">
                                    <div class="md:col-span-1">
                                        <label for="dropzone-file"
                                            ...
                                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                ...
                                                <p class="mb-2 text-sm text-gray-500"><span
                                                        class="font-semibold">Drag & Drop</span> or click to upload
                                                </p>
                                        ...
                                        <button type="submit"
                                            class="mt-4 px-4 py-2 bg-blue-600 text-white rounded">Upload</button>
                                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        addEmploymentButton.addEventListener('click', function() {
            if (employmentCount < maxEmployment) {
                ...
                document.getElementById(`employment${employmentCount}-label`).classList.remove(
                'hidden');
            }
        });
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        addCharacterReferenceButton.addEventListener('click', function() {
            if (characterReferenceCount < maxCharacterReferences) {
                ...
                document.getElementById(`character-reference${characterReferenceCount}`).classList
                    .remove('hidden');
                document.getElementById(`character-reference${characterReferenceCount}-label`).classList
                    .remove('hidden');
            }
        });
