<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        @endif
        <div class="relative">
            <h1 class="text-2xl md:text-2xl text-slate-800 dark:text-slate-100 font-bold mb-12 lg:px-4">Branch Info</h1>
        </div>
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <!-- Add view button -->
                <a href="{{ route('branches.create') }}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                    <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                        <path
                            d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                    </svg>
                    <span class="xs:block ml-2">Add Branch</span>
                </a>
                {{-- <a id="show-modal" href="#" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                    ...
                    <span class="xs:block ml-2">Import Branch</span>
                </a> --}}
                                        ...
                                        <div class="sm:flex sm:items-start">
                                            ...
                                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                <h3 class="text-base font-semibold leading-6 text-gray-900"
                                                    id="modal-title">Import Denomination</h3>
                                                <div class="mt-2">
                                                    <div class="fields">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-500 dark:bg-gray-900">
                                    @foreach ($branches as $branch)
                                        <tr>
                                            ...
                                            <td
                                                class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 text-justify whitespace-normal">
                                                {{ $branch->location }}
                                            </td>
                                            <td
                                                class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                            ...
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                <div class="flex items-center gap-x-6">
                                                    <form method="POST" action="{{ route('branches.assignUser', $branch) }}">
                                                        ...
                                                        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Assign User</button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
