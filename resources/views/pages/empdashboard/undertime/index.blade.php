        ...
        <div class="flex">
            ...
            <div class="w-3/4 bg-white p-8">
                <form action="#" method="POST">
                    @csrf
                    <h2 class="text-xl font-semibold mb-2 pt-8">Undertime Request Form</h2>
                    <p class="text-gray-600 text-sm mt-2 mb-8">Please fill out the form below to submit your undertime request. Ensure all fields are completed accurately.</p>
