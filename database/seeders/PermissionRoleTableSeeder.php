...
class PermissionRoleTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $branch_permissions = $superadmin_permissions->filter(function ($permission) {
            return substr($permission->title, 0, 5) != 'role_' && substr($permission->title, 0, 11) != 'permission_' && substr($permission->title, 0, 6) != 'super_' && substr($permission->title, 0, 6) != 'admin_' && substr($permission->title, 0, 5) != 'user_' && substr($permission->title, 0, 3) != 'hr_' && substr($permission->title, 0, 5) != 'loan_' && substr($permission->title, 0, 8) != 'auditor_' && substr($permission->title, 0, 8) != 'collector_' ;
        });
        Role::findOrFail(4)->permissions()->sync($branch_permissions);
        $loan_permissions = $superadmin_permissions->filter(function ($permission) {
            return substr($permission->title, 0, 5) != 'role_' && substr($permission->title, 0, 11) != 'permission_' && substr($permission->title, 0, 6) != 'super_' && substr($permission->title, 0, 6) != 'admin_' && substr($permission->title, 0, 5) != 'user_' && substr($permission->title, 0, 7) != 'branch_' && substr($permission->title, 0, 3) != 'hr_' && substr($permission->title, 0, 8) != 'auditor_' && substr($permission->title, 0, 8) != 'collector_' ;
        });
        Role::findOrFail(5)->permissions()->sync($loan_permissions);
        $auditor_permissions = $superadmin_permissions->filter(function ($permission) {
            return substr($permission->title, 0, 5) != 'role_' && substr($permission->title, 0, 11) != 'permission_' && substr($permission->title, 0, 6) != 'super_' && substr($permission->title, 0, 6) != 'admin_' && substr($permission->title, 0, 5) != 'user_' && substr($permission->title, 0, 7) != 'branch_' && substr($permission->title, 0, 3) != 'hr_' && substr($permission->title, 0, 5) != 'loan_' && substr($permission->title, 0, 8) != 'collector_' ;
        });
